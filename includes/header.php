...
?>
  ...
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;300;400;500;600&family=Tenor+Sans&display=swap"
      rel="stylesheet" />
      <!-- bootstrap 5 -->
  ...
  <body>
    ...
    <header class="header">
      ...
      <div data-aos="zoom-in-left" data-aos-delay="1450" class="support ">
        ...
        <a data-aos="zoom-in-left" data-aos-delay="1300" href="package.php"
          class="btn"><?php echo $lang['bookNow'] ?></a>
      </div>
    </header>
